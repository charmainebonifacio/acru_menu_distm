# The ACRU Distributed Mode Menu Generator

This fortran script that will automatically convert the current MENU file into an appropriate parameter file in distributed mode.
